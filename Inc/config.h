...
#define N_MOT_MAX       1500            // [rpm] Maximum motor speed limit (was 1000)

// Field Weakening / Phase Advance
#define FIELD_WEAK_ENA  1               // [-] Field Weakening / Phase Advance enable flag: 0 = Disabled (default), 1 = Enabled (CHANGED for higher speed)
